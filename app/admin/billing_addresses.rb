ActiveAdmin.register BillingAddress do
  ...
  controller do
    def update
      ...
      @error_messages = []
      @address_changer = BillingAddress::Changer.new(resource, @subscription, permitted_params[:billing_address])
      ...
      if @error_messages.any?
        ...
        redirect_to admin_billing_address_path(resource)
      end
    end
  end
  ...
  permit_params :line_1, :line_2, :city, :state, :zip, :country
end
